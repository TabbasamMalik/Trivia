...
import com.trivia.quizapp.services.RequestQuestionService;
import com.trivia.quizapp.utils.Constants;
import com.trivia.quizapp.utils.NetworkHelper;
import com.trivia.quizapp.viewmodel.QuizViewModel;
import com.trivia.quizapp.viewmodel.ScoreViewModel;
...
//            startService(intent);
    ...
    private void generateQuizData() {
        ...
        hard_soft.setText(currentQuestion.getDifficulty()+"");
        options = new ArrayList<>();
        options.add(currentQuestion.getCorrect_answer());
        for (String incorrectAnswer : currentQuestion.getIncorrect_answers()) {
            options.add(incorrectAnswer);
